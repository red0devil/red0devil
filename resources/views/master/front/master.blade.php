                ...
                <div class="nav-inner">
                    ...
                    <div class="mega-category-menu">
                        ...
                        <ul class="sub-category">
                            ...
                            <li>
                                <a href="{{route('product-catagory', ['id' => $category->id])}}">{{$category->name}}
                                ...
                                <ul class="inner-sub-category">
                                    ...
                                    <li><a href="{{route('product-sub-catagory', ['id' => $subCategory->id])}}">{{$subCategory->name}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            @endforeach
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-12">
                        <div class="payment-gateway">
                            <span>We Accept:</span>
                            <img src="{{asset('/')}}front/assets/images/footer/credit-cards-footer.png" alt="#">
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
...
<!-- xzoom js plugin here -->

<script src="{{asset('/')}}front/assets/js/setup.js"></script>
