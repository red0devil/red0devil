        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    ...
                    <div class="images">
                        <img src="{{asset('/')}}front/assets/images/featured-categories/fetured-item-1.png" alt="#">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    ...
                    <div class="images">
                        <img src="{{asset('/')}}front/assets/images/featured-categories/fetured-item-2.png" alt="#">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    ...
                    <div class="images">
                        <img src="{{asset('/')}}front/assets/images/featured-categories/fetured-item-3.png" alt="#">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    ...
                    <div class="images">
                        <img src="{{asset('/')}}front/assets/images/featured-categories/fetured-item-4.png" alt="#">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    ...
                    <div class="images">
                        <img src="{{asset('/')}}front/assets/images/featured-categories/fetured-item-5.png" alt="#">
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    ...
                    <div class="images">
                        <img src="{{asset('/')}}front/assets/images/featured-categories/fetured-item-6.png" alt="#">
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    ...
                    <div class="product-info">
                        ...
                        <div class="price">
                            <span>TK. {{number_format($product->selling_price)}}</span>
                            <span class="discount-price text-center">TK. {{number_format($product->regular_price)}}</span>
                        </div>
                    </div>
                </div>
