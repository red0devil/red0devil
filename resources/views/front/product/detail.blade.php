                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        ...
                        @foreach($product->otherImages as $subImage)
                                    <a href="{{asset($subImage->image)}}">
                                        <img class="xzoom-gallery" width="80" src="{{asset($subImage->image)}}"  xpreview="{{asset($subImage->image)}}" title="The description goes here"></a>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag">Category Name</i>
                                <a href="javascript:void(0)">{{$product->category->name}}</a>
                            </p>
                            <p class="category"><i class="lni lni-tag">Brand Name</i>
                                <a href="javascript:void(0)">{{$product->brand->name}}</a>
                            </p>
                            <h3 class="price">TK.{{number_format($product->selling_price)}}<span>TK.{{number_format($product->regular_price)}}</span></h3>
                            <p class="info-text">{{$product->short_descriptioon}}</p>
                        ...
                        <div class="single-block">
                            <div class="reviews">
                                ...
                                <div class="single-review">
                                    <img src="{{asset('/')}}front/assets/images/blog/comment1.jpg" alt="#">
                                ...
                                <div class="single-review">
                                    <img src="{{asset('/')}}front/assets/images/blog/comment3.jpg" alt="#">
                                    <div class="review-info">
